    ...
    return (
        <div className="relative flex flex-col gap-10 items-center group text-center pt-0 bg-white shadow-3xl bg-clip-border rounded-xl h-[428px] w-96">
            ...
            <div className="p-6 flex flex-col gap-4 items-center">
                <DefaultButton
                    classNames="relative w-14 h-14 border-2 border-blue group-hover:bg-blue bg-white text-blue group-hover:text-white focus:ring focus:ring-blue active:opacity-[0.85] rounded-full">
                ...
                <DefaultButton anchor={true} onPress={"/contact-us"} classNames={"bg-white"} >
