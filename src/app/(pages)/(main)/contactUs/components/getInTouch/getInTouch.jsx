...
const GetInTouch = ({ }) => {
    return (
        <div className="container mx-auto grid lg:grid-cols-[30%_auto] gap-10 lg:py-20 py-10" >
            <div className=" flex flex-col gap-6 p-10 bg-blue text-white ">
            ...
            <div className=" p-5 flex flex-col gap-4">
               <h2 className="text-5xl font-semibold">Get In Touch<span className="text-gray"> With Us</span></h2>
